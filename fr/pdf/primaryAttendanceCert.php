...
$pdf->AddPage();
 ...
 $pdf->Ln();
 $pdf->Cell(45,7,"",0);
$pdf->Cell(70,7,"SCHOOL ATTENDANCE CERTIFICATE",0);
$pdf->SetFont('times','',11);
$pdf->Ln();
$pdf->Cell(10,7,"I, the undersigned head teacher of ".$Model->GetSchoolInfo(2)[0]['name'].", certify that the pupil ",0);
$pdf->Ln();
...
$pdf->Cell(10,7,"is a registered student in this institution during the ".$yearname." academic year.",0);
$pdf->Ln();
$pdf->Ln();
...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(10,7,"Done at________________, on the _______________                                                Head Teacher__________________",0);
$pdf->Output();

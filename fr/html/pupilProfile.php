...
<div class="row">
        ...
        <div class="col-xs-8">
            <p><a target="blank" href="./pdf/profilePdf.php?ref=<?= $student_code ?>" title="Save as PDF" class="btn btn-primary"><i class="glyphicon glyphicon-download"></i> <?= $lang[$_SESSION['lang']]["Save list as PDF"] ?></a></p>
        </div>
        <div class="col-xs-3">

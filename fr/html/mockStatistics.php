...
<div class="row">
        ...
        <div class="col-xs-8">
            <p><a target="blank" href="./pdf/MockStatPdf.php?<?= $url ?>" title="Save as PDF" class="btn btn-primary"><i class="glyphicon glyphicon-download"></i> Save the Stats as PDF</a></p>
        </div>
        <div class="col-xs-3">

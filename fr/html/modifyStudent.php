<?php
    $student = $Model->GetStudent($_GET['ref'], $section);
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if (!$err){
            $code = $_GET['ref'];
            $data = [strToUpper($name), $gender,$dob, strToUpper($pob), StrToUpper($gName), $gNum, $gEmail, $gAddress,strToUpper($motherName), strToUpper($fatherName), $admNum, $code];
            ...
            if($result = "Successful"){
                ...
                echo '<script>window.location="index.php?p=students"</script>';
            }
        }
    }
...
<div class="row">
    ...
    <div class="col-md-8 col-sm-8 col-xs-8">
        <label id="label1"><?= $lang[$_SESSION['lang']]["ModifyStudentInfo"] ?></label>
